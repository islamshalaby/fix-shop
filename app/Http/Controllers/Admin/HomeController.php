...
class HomeController extends AdminController{
    ...
    public function show(){
        ...
        ->select('products.id', 'products.price_before_offer', 'products.final_price', 'products.remaining_quantity', 'products.title_en','products.title_ar', DB::raw('SUM(order_items.count) as cnt'))
