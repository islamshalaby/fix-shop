                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="td-content pricing"><span class="">{{ $recent_order->total_price . " " . __('messages.ryal') }}</span></div></td>
                                <td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="td-content"><span class="pricing">{{ $sold_product->multi_options == 0 ? $sold_product->price_before_offer . " " . __('messages.ryal') : $sold_product->option_price_before_offer . " " . __('messages.ryal') }}</span></div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ $sold_product->multi_options == 0 ? $sold_product->final_price . " " . __('messages.ryal') : $sold_product->option_price . " " . __('messages.ryal') }}</span></div></td>
