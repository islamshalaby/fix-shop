    ...
    <script>
        ...
        $("#categories-container").on('click', '.form-group select', function() {
            ...
            $(".actions ul").find('li').eq(1).on('click', function() {
                ...
                installationRequired = "{{ __('messages.installation_required') }}"
                ...
                $("input[name='installation_cost']").on('keyup', function() {
                    if ( !$(this).val() ) {
                        $(this).attr('valid', "0")
                        if ($(this).next('.installation-required').length) {

                        }else {
                            $(this).after(`
                            <div style="margin-top:20px" class="alert alert-outline-danger mb-4 installation-required" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x close" data-dismiss="alert"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button><i class="flaticon-cancel-12 close" data-dismiss="alert"></i> ${installationRequired}</div>
                            `)
                        }
                    }else {
                        $(this).attr('valid', "1")
                        $(this).next('.installation-required').remove()
                    }
                })
                    ...
                    $(".actions ul").find('li').eq(2).on("mouseover", "a", function() {
                        ...
                        if ($("#discount").is(":checked")) {
                            if ($("input[name='price_before_offer']").attr('valid') == "1" && 
                                ...
                                $("input[name='installation_cost']").attr('valid') == "1") {
                            ...
                            console.log("islam")
                            if ($("input[name='remaining_quantity']").attr('valid') == "1" && 
                            $("input[name='total_quatity']").attr('valid') == "1" && 
                            $("input[name='price_before_offer']").attr('valid') == "1" && 
                            $("input[name='installation_cost']").attr('valid') == "1") {
                                $(this).attr('href', "#finish")
                            }else {
                                $(this).attr('href', "#")
                        ...
                        <section>
                            <div id="single-details">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input required type="number" valid="1" name="total_quatity" class="form-control" id="total_quatity" placeholder="{{ __('messages.total_quatity') }}" value="{{ $data['product']['total_quatity'] }}" >
                                </div>
                                <div class="form-group mb-4">
                                    <label for="remaining_quantity">{{ __('messages.remaining_quantity') }} *</label>
                                    <input required type="number" valid="1" name="remaining_quantity" class="form-control" id="remaining_quantity" placeholder="{{ __('messages.remaining_quantity') }}" value="{{ $data['product']['remaining_quantity'] }}" >
                                </div>
                                <div class="form-group mb-4">
                                    <label for="price_before_offer">{{ __('messages.product_price') }} *</label>
                                    <input required type="number" valid="1" step="any" min="0" name="price_before_offer" class="form-control" id="price_before_offer" placeholder="{{ __('messages.product_price') }}" value="{{ $data['product']['price_before_offer'] }}" >
                                </div>
                                <div class="form-group mb-4">
                                    <label for="installation_cost">{{ __('messages.installation_cost') }}</label>
                                    <input required type="number" valid="1" step="any" min="0" name="installation_cost" class="form-control" id="installation_cost" placeholder="{{ __('messages.installation_cost') }}" value="{{ $data['product']['installation_cost'] }}" >
                                </div>
                                <div class="form-group mb-4">
                                    <label for="stored_number">{{ __('messages.product_stored_number') }}</label>
                                    <input type="text" name="stored_number" class="form-control" id="stored_number" placeholder="{{ __('messages.product_stored_number') }}" value="{{ $data['product']['stored_number'] }}" >
                                </div>
                                <div class="form-group mb-4">
                                    <label for="barcode">{{ __('messages.barcode') }}</label>
                                    <input type="text" name="barcode" class="form-control" id="barcode" placeholder="{{ __('messages.barcode') }}" value="{{ $data['product']['barcode'] }}" >
                                </div>
                            </div>
