            ...
            <div class="row">
                ...
                <div class="widget-content widget-content-area col-md-3">
                    <div class="card component-card_2">
                        <img src="https://res.cloudinary.com/{{ cloudinary_app_name() }}/image/upload/w_250,h_250,q_100/v1581928924/{{ isset($product->images[0]) ? $product->images[0]->image : '' }}" class="card-img-top" alt="widget-card-2">
                        <div class="card-body">
