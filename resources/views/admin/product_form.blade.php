    ...
    <script>
        ...
        {{-- $("#vat_percentage").on('keyup', function() {
            var vat = $(this).val(),
                ...
                vatValue = Number(price) * (Number(vat) / 100),
                totalWithVat = vatValue + Number(finalPrice)

            $("#vat_value").val(vatValue)
            $("#final_price").val(totalWithVat)
        }) --}}
                        ...
                        <section>
                            ...
                            <div id="single-details">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input required type="number" step="any" min="0" name="installation_cost" class="form-control" id="installation_cost" placeholder="{{ __('messages.installation_cost') }}" >
                                </div>
                                ...
                                {{-- <div class="form-group mb-4">
                                    <label for="vat_percentage">{{ __('messages.vat') }} *</label>
                                    <input required type="number" step="any" min="0" name="vat_percentage" class="form-control" id="vat_percentage" placeholder="{{ __('messages.vat') }}" value="{{ old('vat_percentage') }}" >
                                </div>
                                <input required type="hidden" step="any" min="0" name="vat_value" class="form-control" id="vat_value" placeholder="{{ __('messages.vat_value') }}" value="{{ old('vat_value') }}" > --}}
                            </div>
