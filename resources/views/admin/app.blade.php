                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission']))
                    ...
                    <li class="menu discounts">
                        <a href="#discounts" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                ...
                                <span>{{ __('messages.discount_systems') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="discounts" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                <li class="active add">
                                    <a href="{{ route('discounts.create') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="{{ route('discounts.index') }}"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu products">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="products" data-parent="#accordionExample">
                            ...
                            <li class="offers" >
                                <a href="{{ route('products.getOffers') }}"> {{ __('messages.offers') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
