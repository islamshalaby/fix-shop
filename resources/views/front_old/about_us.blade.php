    ...
    <main id="main">
        ...
        <section class="section-About section-t8">
            <div class="container p-4">
                <div class="row">
                    <div class="col-lg-5">
                        <img src="/front/assets/img/img.jpg" alt="">
                    </div>
                    <div class="col-lg-7">
                        <h6>About company</h6>
                        <h3>We offer you the perfect buying experience</h3>
                        <p>Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card
                            Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card</p>
                    ...
                    <div class="col-lg-12 title-spot">
                        <h3>Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card</h3>
                    </div>
                </div>
