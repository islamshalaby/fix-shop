...
<body>
            ...
            <div class="container d-flex justify-content-between">
                ...
                <div class="contact-info d-flex TopBarLeft align-items-center">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-person-fill"></i>Sign
                                In</a>
                        </li>
                ...
                <div class="header-container d-flex align-items-center justify-content-between">
                    <div id="navbar" class="navbar">
                        <ul>
                            ...
                            <li class="dropdown scr Mob-d"><a href="#"><span> categories</span> <i
                            ...
                            <li><a class="nav-link " href="#">Offers<span class="Hot">Hot</span></a></li>
    ...
    <main id="main">
            ...
            <div class="container p-0">
                <div class="productTopBox">
                    <div class="row">
                        <div class="col-lg-3 col-md-4  col-12">
                            <div class="PhotoBox"><img src="/front/assets/img/1_03.jpg" class="img-fluid" alt=""></div>
                        </div>
                ...
                <div class="ProductDetailsBox">
                    <div class="title-wrap d-flex justify-content-between">
                        <div class="title-box">
                            <h2 class="title-a"> Product Details</h2>
                        </div>

                    </div>
                    <p>to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to
                        win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to
                        win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes cardBuy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to
                        win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card</p>
                    <p>Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card</p>
                </div>
                                        ...
                                        <div class="view view-sixth card-img-top">
                                            ...
                                            <div class="mask ">
                                                <div class="actionBut">
                                                    ...
                                                    <a href="#" class="info viewProduct">View product</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
        ...
        <!-- ======= Latest product-details Section ======= -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-contact">
                        <h4>You can download the application <span>.</span></h4>
    ...
    <script src="/front/assets/lib/php-email-form/validate.js"></script>
