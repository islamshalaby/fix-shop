                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 section-t8">
                        <div class="row">
                            <div class="col-md-7">
                                <h3>Contact Us</h3>
                                <p>Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD</p>
                                ...
                                <div class="ContactInfo">
                                    ...
                                    <div class="section-b2">
                                        <div class="icon-box">
                                            ...
                                            <p>26th July St., 3rd Floor, Sphinx Square, <br>El Mohandeseen, Cairo, Egypt,</p>
                                        </div>
                                        <div class="icon-box">
                                            <span class="bi bi-phone-vibrate"></span>
                                            <p class="">0114 32 77715</p>
                                        </div>
                                        <div class="icon-box">
                                            <span class="bi bi-envelope"></span>
                                            <a href="Mailto:contact@example.com" class="">contact@example.com</a>
                                        </div>

                                        <div class="social-box">
                                            <div class="">

                                                <h5 class="icon-title">Social networks</h5>
                                                <p>Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD</p>
                                            </div>
