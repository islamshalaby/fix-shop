                ...
                <div class="header-container d-flex align-items-center justify-content-between">
                    <div id="navbar" class="navbar">
                        <ul>
                            ...
                            <li class=""><a class="nav-link" href="about.html">About Us</a></li>
                            <li class="dropdown scr Mob-d"><a href="categories.html"><span> categories</span> <i
                            ...
                            <li><a class="nav-link " href="products-list.html">Offers<span class="Hot">Hot</span></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="card DetailsPriceBox">
                            ...
                            <a href="Payment.html" class="PaymentMethod m-3">Payment </a>
