                    ...
                    <div class="col-sm-12 section-t8">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <p>Enter the password and a code will be <br>sent to reset it</p>
                                    <div class="row">
                                        ...
                                        <div class="mb-12 d-flex forgotPasswordLink">
                                            <button type="submit" class="btn btn-a btn-orange">submit</button>
                                ...
                                <div class="LoginBox">
                                    ...
                                    <p>Buy an iTunes card 100 KWD and enter<br><br>
                                         the draw to win a 1000 KWD iTunes card Buy an iTunes<br>
                                          ...
                                          <a href="login.html" class="btn btn-a btn-orange">Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
