        ...
        <div class="box-collapse-wrap form">
            ...
            <div class="flex-shrink-0 bg-white">
                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        <button class="btn btn-toggle btn-dropdown rounded" data-bs-toggle="collapse"
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle btn-dropdown rounded collapsed" data-bs-toggle="collapse"
                            data-bs-target="#Platforms-collapse" aria-expanded="false">
                            Gaming Platforms
                        </button>
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle btn-dropdown rounded collapsed" data-bs-toggle="collapse"
                            data-bs-target="#Game-collapse" aria-expanded="false">
                            Game cards
                        </button>
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle btn-dropdown rounded collapsed" data-bs-toggle="collapse"
                            data-bs-target="#Shopping-collapse" aria-expanded="false">
                            Shopping Cards
                        </button>
            ...
            <div class="container d-flex justify-content-between">
                ...
                <div class="contact-info d-flex TopBarLeft align-items-center">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span><img
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="login.html" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                    class="bi bi-person-fill"></i>Sign
                                In</a>
                            <div class="dropdown-menu">
                ...
                <div class="row align-items-end align-items-md-center">
                    ...
                    <div class="col-lg-7 col-md-7 order-md-2">
                        <div class="input-group search_top select">
                            <select class="minimal" name="jumpMenu" id="jumpMenu"
                    ...
                    <div class="col-sm-12 section-t8">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <form action="forms/contact.php" method="post" role="form" class="email-form LoginBox">
                                    <h5>New customer?</h5>
                                <p>If you already have an account, please login</p>
                                    <div class="row">
                                        ...
                                        <div class="mb-12 d-flex forgotPasswordLink">
                                            <button type="submit" class="btn btn-a btn-orange">Login</button>
                            ...
                            <div class="col-md-5 section-md-t3">
                                <div class="socialLogin">
                                    <a href="#" class="GoogleLogin"><i class="bi bi-google"></i>Sign in with Google</a>
                                    <a href="#" class="FacebookLogin"><i class="bi bi-facebook"></i>Sign in with
                                        Facebook</a>
                                </div>

                                <div class="LoginBox">
                                    <h5>Already a client?</h5>
                                    <p>Buy an iTunes card 100 KWD and enter<br><br>
                                         the draw to win a 1000 KWD iTunes card Buy an iTunes<br>
                                          card 100 KWD and enter the draw to win a 1000 KWD <br>
                                          iTunes card Buy an iTunes card 100 KWD and enter the draw to win a 1000 KWD</p>
                                    <a href="register.html"  class="btn btn-a btn-orange">Register Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
